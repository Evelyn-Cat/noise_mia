...
TODO 2024.10.28
1 check the rdp and ma computation for both plrv and gaussian.
2 search the noise and save the parameters with the distributions and objective function as an input.
3 find the optimal hyperparameters for main task.
4 find the plrve noise pairs
