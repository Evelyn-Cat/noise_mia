...
def main(sensitivity, alpha, T=1, filename=None):
    cnt = 0
    filename = f"results/14.sen_{sensitivity}_alpha_{alpha}_T_{T}.txt" if filename==None else filename
    ...
    for combination in all_combinations:
        ...
        objective = param_dict["G_k"] * param_dict["G_theta"] + (param_dict['U_a'] + param_dict['U_b'])/2
