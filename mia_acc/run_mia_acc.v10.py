...
version = "v8"
Qt_filepath="cfg_noise/v8.Qt.txt"
suffix_columns = ["clip", "G_k", "G_theta"]
## load mg noise configs
cfg = load_txt(Qt_filepath, columns=suffix_columns)
...
try:
    ...
    clip, G_k, G_theta = cfg.loc[0, suffix_columns]
...
if prefix_noise_type == "mg":
    try:
        ...
        out_line=f"print_results#{clip}#{q}#{G_k}#{G_theta}#{accuracy_maintask}#{accuracy_mia}"
